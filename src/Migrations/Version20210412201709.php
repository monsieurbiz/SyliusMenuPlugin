 ...
 */
final class Version20210412201709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE monsieurbiz_menu_item (id INT AUTO_INCREMENT NOT NULL, menu_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', position INT NOT NULL, highlighted TINYINT(1) DEFAULT NULL, INDEX IDX_D472D900CCD7E912 (menu_id), INDEX IDX_D472D900727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE monsieurbiz_menu_item_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT NOT NULL, url VARCHAR(255) DEFAULT NULL, label VARCHAR(255) NOT NULL, headline VARCHAR(255) DEFAULT NULL, locale VARCHAR(255) NOT NULL, INDEX IDX_2591643F2C2AC5D3 (translatable_id), UNIQUE INDEX monsieurbiz_menu_item_translation_uniq_trans (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
