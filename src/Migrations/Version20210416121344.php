...
final class Version20210416121344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE monsieurbiz_menu_item_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT NOT NULL, url VARCHAR(255) DEFAULT NULL, label VARCHAR(255) NOT NULL, locale VARCHAR(255) NOT NULL, INDEX IDX_2591643F2C2AC5D3 (translatable_id), UNIQUE INDEX monsieurbiz_menu_item_translation_uniq_trans (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
